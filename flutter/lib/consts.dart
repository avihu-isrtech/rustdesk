...
const String kOptionHideFloatingWindowOption = "hide-floating-window-option";
const String kOptionHideKeepScreenOnOption = "hide-keep-screen-on-option";
const String kOptionHideWarningAboutGivenPermissionsMidSession = "hide-warning-about-given-permissions-mid-session";
const String kOptionDisallowTurningOffStartedService = "disallow-turning-off-started-service";
